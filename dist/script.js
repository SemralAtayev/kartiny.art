...
/* harmony import */ var _modules_scrollTop__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/scrollTop */ "./src/js/modules/scrollTop.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_burgerMenu__WEBPACK_IMPORTED_MODULE_10__["default"])('.burger', '.burger-menu');
  Object(_modules_scrollTop__WEBPACK_IMPORTED_MODULE_11__["default"])('.pageup');
});
...
var accordeon = function accordeon(headerSelector) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burgerMenu = function burgerMenu(burgerTrigger, burgerMenuSelector) {
  var burgerIcon = document.querySelector(burgerTrigger);
  var burgerMenu = document.querySelector(burgerMenuSelector);
  burgerMenu.style.display = "none";
  burgerIcon.addEventListener("click", function () {
    if (getComputedStyle(burgerMenu).display == "none" && window.screen.availWidth < 993) {
...
var forms = function forms(state) {
  ...
  var clearAllInputs = function clearAllInputs(inputSelector) {
  ...
  upload.forEach(function (inputText) {
    inputText.addEventListener('input', function () {
      var name = inputText.files[0].name.split('.');
      var dot;
      var nearDiv = inputText.previousElementSibling;
  ...
  var sendRequest = function sendRequest() {
    forms.forEach(function (form) {
      form.addEventListener("submit", function (e) {
        e.preventDefault(); //creating div to place img and text

        var messageStatus = document.createElement("div");
        messageStatus.classList.add("status"); //appending to form block

        form.parentNode.appendChild(messageStatus); //remove form from popup
        ...
        var textBlock = document.querySelector("p");
        ...
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_7__["request"])(api, formData).then(function (request) {
          ...
          setTimeout(function () {
            ...
            messageStatus.remove(); //close all modal windows 
...
var scrollTop = function scrollTop(upSelector) {
...
var styles = function styles(trigger, selector) {
  var loadMore = document.querySelector(trigger);
  loadMore.addEventListener("click", function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getRequest"])("http://localhost:3000/styles").then(function (res) {
      renderCart(res);
    });
    loadMore.remove();
  });
  ...
  function renderCart(responde) {
    responde.forEach(function (_ref) {
      var src = _ref.src,
          title = _ref.title,
          link = _ref.link;
      var cartElement = document.createElement("div");
      cartElement.classList.add("fadeIn", "animated", "col-sm-3", "col-sm-offset-0", "col-xs-10", "col-xs-offset-1");
...
/*!*************************************!*\
  !*** ./src/js/services/requests.js ***!
  \*************************************/
/*! exports provided: request, getRequest */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.next = 5;
          return regeneratorRuntime.awrap(fetchRequest.text());
...
var getRequest = function getRequest(url) {
  var fetchRequest;
  return regeneratorRuntime.async(function getRequest$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fetch ".concat(url, ", status: ").concat(fetchRequest.status));

        case 5:
          _context2.next = 7;
          return regeneratorRuntime.awrap(fetchRequest.json());
